...
// Get conversations with filters for manager
...
//       // ✅ Get FULL user profile (all columns)
...
//       );
//       console.log(
//         `🔍 Filtered by operator_type: ${operator_type}, found ${filtered.length}`,
//       );
//     }
...
//     query = query.order("reported_at", { ascending: false }).range(from, to);
...
//     // Get unique IDs for batch fetching (better performance)
//     const reporterIds = [
...
//     // Fetch all reporters at once
//     const { data: reporters } = await supabase
//       .from("user_profiles")
//       .select("id, display_name, email")
//       .in("id", reporterIds);

//     // Fetch all fictional profiles at once
...
//     const fictionalMap = new Map(fictionals?.map((f) => [f.id, f]) || []);

//     // Build reports with names
...
//       reported_fictional_id: report.reported_fictional_id,
//       reporter_profile: reporterMap.get(report.reporter_profile_id) || {
//         display_name: "Unknown User",
//         email: "Unknown",
//       },
...
// Get messages for Message Analytics page (with proper pagination)
...
//     // STEP 6: Calculate today's processed count for each operator
...
//     // STEP 7: Build ALL messages with user/fictional data
...
//       const operator = msg.operator_id
//         ? operatorMap.get(msg.operator_id)
//         : null;
//       const processedToday = operator
//         ? operatorTodayCount[operator.id] || 0
//         : 0;
//       const msgOperatorType = operator
...
//     // STEP 8: Apply filters (operator_type, country, search)
...
//     // STEP 9: Calculate stats (before pagination)
